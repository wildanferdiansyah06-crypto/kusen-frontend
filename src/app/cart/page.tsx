    ...
    <div className="min-h-screen bg-[var(--color-cream)]">
      ...
      <main className="pt-24">
        ...
        <div className="container-main py-12">
          {cartItems.length === 0 ? (
            <div className="bg-[var(--color-parchment)] rounded-2xl p-12 text-center border border-[var(--color-mist)]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2 space-y-6">
                {cartItems.map((item) => (
                  <div key={item.kusen.id} className="bg-[var(--color-parchment)] rounded-2xl p-6 flex gap-6 border border-[var(--color-mist)]">
