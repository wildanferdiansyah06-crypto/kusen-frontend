  ...
  return <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-slate-100">
    ...
    /* Header */
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        {cartItems.length === 0 ? <div className="bg-white rounded-3xl shadow-2xl p-12 text-center border border-gray-100">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 sticky top-24">
                ...
                <div className="space-y-4 mb-6">
                  {cartItems.map((item) => <div key={item.kusen.id} className="flex gap-4 pb-4 border-b border-gray-100">
                      {item.kusen.gambarUrl ? <Image
