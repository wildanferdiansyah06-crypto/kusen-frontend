...
export const metadata: Metadata = {
  ...
  description:
    'Kenali cerita, nilai, dan proses kerja Kusen Nusantara dalam menghadirkan kusen kayu premium untuk hunian dan proyek komersial di seluruh Indonesia.',
};
...
const processSteps = [
  {
    ...
    description:
      'Kami memahami gaya hunian, ukuran bukaan, budget, hingga target waktu pemasangan.',
  },
  {
    title: 'Kurasi Material',
    description:
      'Setiap kayu dipilih berdasarkan kadar air, stabilitas serat, dan kesesuaian untuk desain Anda.',
  },
  {
    title: 'Produksi Presisi',
    description:
      'Pengerjaan oleh pengrajin berpengalaman dengan standar dimensi ketat agar pemasangan rapi.',
  },
  {
    title: 'QC & Pengiriman',
    description:
      'Produk melalui inspeksi akhir sebelum dikirim aman ke proyek rumah maupun bangunan komersial.',
  },
];
...
const team = [
  ...
  },
  {
    ...
    image:
      'https://images.pexels.com/photos/614810/pexels-photo-614810.jpeg?auto=compress&cs=tinysrgb&w=1000',
  },
];
              ...
              <div>
                ...
                <div className="mt-6 space-y-3">
                  {[
                    ...
                    <div key={point} className="flex items-start gap-3 text-[var(--color-stone)]">
              ...
              <div>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={item} className="flex items-start gap-3 text-[var(--color-stone)]">
                      <CheckCircle2 className="w-5 h-5 mt-0.5 text-[var(--color-success)]" />
                      <span>{item}</span>
                    </div>
                  ))}
