...
function Footer() {
  return <footer className="bg-[var(--color-walnut)] text-white">
    ...
    /* Brand Column */
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a href="https://instagram.com/a.fardhan.a" target="_blank" rel="noopener noreferrer" className="p-2 hover:bg-[var(--color-teak)] rounded-full transition-colors" aria-label="Instagram">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    /* Company Column */
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/tentang" className="text-[var(--color-mist)] hover:text-white transition-colors inline-block hover:translate-x-2 transform duration-200">
                  Tentang Kami
                </Link>
              </li>
              <li>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-[var(--color-mist)] text-sm">
                  Jl. Jember, Utara Balai Desa Silo, Jember, Indonesia
                </span>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="w-5 h-5 text-[var(--color-gold)] flex-shrink-0" />
                <a href="https://wa.me/6281936442406" target="_blank" rel="noopener noreferrer" className="text-[var(--color-mist)] text-sm hover:text-white transition-colors">
